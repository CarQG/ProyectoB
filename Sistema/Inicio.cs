...
namespace Sistema
{
    public partial class Inicio : Form
    {
        ...
        private void Inicio_Load(object sender, EventArgs e)
        {
            ...
            if (opersona.TipoPermiso != "ADMINISTRADOR")
            {
        ...
        {
            BotonActivo((Button)sender);
            AbrirFormulario(new frmRegistrarEntradas(opersona));
        }

        private void btnegresos_Click(object sender, EventArgs e)
        {
            BotonActivo((Button)sender);
            AbrirFormulario(new frmRegistrarSalidas(opersona));
        }
        ...
        {
            BotonActivo((Button)sender);
            AbrirFormulario(new frmListaEntradas());
        }
        ...
        {
            BotonActivo((Button)sender);
            AbrirFormulario(new frmListaSalidas());
        }
