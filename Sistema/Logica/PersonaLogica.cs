        ...
        public int Guardar(Persona objeto,out string mensaje)
        {
            ...
            try {
                ...
                using (SQLiteConnection conexion = new SQLiteConnection(Conexion.cadena))
                {
                    ...
                    cmd.Parameters.Add(new SQLiteParameter("@documento", objeto.Usuario));
                    cmd.Parameters.Add(new SQLiteParameter("@nombres", objeto.Nombres));
                    cmd.Parameters.Add(new SQLiteParameter("@correo", objeto.Correo));
                    cmd.Parameters.Add(new SQLiteParameter("@clave", objeto.Contraseña));
                    cmd.Parameters.Add(new SQLiteParameter("@tipopersona", objeto.TipoPermiso));
                ...
                using (SQLiteConnection conexion = new SQLiteConnection(Conexion.cadena))
                {
                    ...
                    using (SQLiteDataReader dr = cmd.ExecuteReader())
                    {
                        while (dr.Read())
                        {
                            ...
                            {
                                IdUsuario = int.Parse(dr["IdPersona"].ToString()),
                                Usuario = dr["Documento"].ToString(),
                                Nombres = dr["Nombres"].ToString(),
                                Correo = dr["Correo"].ToString(),
                                Contraseña = dr["Clave"].ToString(),
                                TipoPermiso = dr["TipoPersona"].ToString()
                            });
                        }
                    }
                }
        ...
        public int Editar(Persona objeto, out string mensaje)
        {
            ...
            try
            {
                ...
                using (SQLiteConnection conexion = new SQLiteConnection(Conexion.cadena))
                {
                    ...
                    SQLiteCommand cmd = new SQLiteCommand(query.ToString(), conexion);
                    cmd.Parameters.Add(new SQLiteParameter("@idpersona", objeto.IdUsuario));
                    cmd.Parameters.Add(new SQLiteParameter("@documento", objeto.Usuario));
                    cmd.Parameters.Add(new SQLiteParameter("@nombres", objeto.Nombres));
                    cmd.Parameters.Add(new SQLiteParameter("@correo", objeto.Correo));
                    cmd.Parameters.Add(new SQLiteParameter("@clave", objeto.Contraseña));
